  ...
  {#if withEvents}
    ...
    >
      ...
      <defs>
          ...
          <rect width="20.9213" height="24" fill="white" transform="translate(1.09326 -0.0539551)"/>
          </clipPath>
      </defs>
    </svg>
  {:else}
