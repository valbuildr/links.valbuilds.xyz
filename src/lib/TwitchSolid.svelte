  ...
  {#if withEvents}
    ...
    >
      ...
      <g clip-path="url(#clip0_22_2)">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M22.453 0V11.9313L14.7831 19.6007H11.3746L7.11322 23.8621V19.6007H2V4.26122L6.26087 0H22.453ZM20.7487 1.70452H7.11322V14.4877H10.9482V17.4703L13.9313 14.4877H17.3402L20.7487 11.0788V1.70452ZM18.192 4.68727V9.80031H16.4877V4.68727H18.192ZM13.5049 4.68727V9.80031H11.8006V4.68727H13.5049Z"/>
      </g>
      <defs>
          <clipPath id="clip0_22_2">
          <rect width="20.5217" height="24" fill="white" transform="translate(2)"/>
          </clipPath>
      </defs>
    </svg>
  {:else}
