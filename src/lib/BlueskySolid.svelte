  ...
  {#if withEvents}
    ...
    >
      ...
      <defs>
          ...
          <rect width="24" height="21.1293" fill="white" transform="translate(0 1)"/>
          </clipPath>
      </defs>
    </svg>
  {:else}
